const makeTripEditTemplate = (trip) => {
  ...
  const makePhotos = (photos) => {
    ...
    photos.forEach(function (photosItem) {
      createdPhotos += createPhoto(photosItem);
    });
  ...
  return `<form class="trip-events__item  event  event--edit" action="#" method="post">
            ...
            <section class="event__details">
              ...
              <section class="event__section  event__section--destination">
                ...
                <p class="event__destination-description">${trip.description}</p>

                <div class="event__photos-container">
                  <div class="event__photos-tape">
                    ${makePhotos(trip.photos)}
                  </div>
                </div>
              </section>
            </section>
